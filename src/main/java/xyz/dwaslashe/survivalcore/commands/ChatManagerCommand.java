        ...
        if (guiID == 0) {
            ...
            ItemStack abyss = inventoryHelper.prepareItemStack(Material.ENDER_EYE, itemStack -> {
                inventoryHelper.editMetaForItemStack(itemStack, itemMeta -> {
                    ...
                    itemMeta.setLore(Api.fixColor(Arrays.asList("", " &#FFC42EAktywne&8: &a" + ((user.getAbyss() == 1) ? "&#39FF14Tak" : "&#FF3131Nie"), "", " &#FBFD8C&nKliknij aby włączyć/wyłączyć informacje!")));
                });
            });
            ...
            ItemStack automsg = inventoryHelper.prepareItemStack(Material.BOOK, itemStack -> {
                inventoryHelper.editMetaForItemStack(itemStack, itemMeta -> {
                    ...
                    itemMeta.setLore(Api.fixColor(Arrays.asList("", " &#FFC42EAktywne&8: &a" + ((user.getAutomsg() == 1) ? "&#39FF14Tak" : "&#FF3131Nie"), "", " &#FBFD8C&nKliknij aby włączyć/wyłączyć informacje!")));
                });
            });
            ...
            ItemStack autobossbar = inventoryHelper.prepareItemStack(Material.BEACON, itemStack -> {
                inventoryHelper.editMetaForItemStack(itemStack, itemMeta -> {
                    ...
                    itemMeta.setLore(Api.fixColor(Arrays.asList("", " &#FFC42EAktywne&8: &a" + ((user.getAutobossbar() == 1) ? "&#39FF14Tak" : "&#FF3131Nie"), "", " &#FBFD8C&nKliknij aby włączyć/wyłączyć informacje!")));
                });
            });
            ...
            ItemStack deaths = inventoryHelper.prepareItemStack(Material.SKELETON_SKULL, itemStack -> {
                inventoryHelper.editMetaForItemStack(itemStack, itemMeta -> {
                    ...
                    itemMeta.setLore(Api.fixColor(Arrays.asList("", " &#FFC42EAktywne&8: &a" + ((user.getDeaths() == 1) ? "&#39FF14Tak" : "&#FF3131Nie"), "", " &#FBFD8C&nKliknij aby włączyć/wyłączyć informacje!")));
                });
            });
            ...
            inventoryHelper.setItem(19, (user.getAbyss() == 1) ? glass_lime : glass_red);
            inventoryHelper.setItem(12, automsg);
            inventoryHelper.setItem(21, (user.getAutomsg() == 1) ? glass_lime : glass_red);
            inventoryHelper.setItem(14, autobossbar);
            inventoryHelper.setItem(23, (user.getAutobossbar() == 1) ? glass_lime : glass_red);
            inventoryHelper.setItem(16, deaths);
            inventoryHelper.setItem(25, (user.getDeaths() == 1) ? glass_lime : glass_red);
        ...
        if (guiID == 1) {
            ...
            ItemStack discord = inventoryHelper.prepareItemStack(Material.LEGACY_SKULL_ITEM, itemStack -> {
                ...
                inventoryHelper.editMetaForItemStack(itemStack, itemMeta -> {
                    ...
                    itemMeta.setLore(Api.fixColor(Arrays.asList("", " &#FFC42EAktywne&8: &a" + ((user.getDiscordchat() == 1) ? "&#39FF14Tak" : "&#FF3131Nie"), "", " &#FBFD8C&nKliknij aby włączyć/wyłączyć informacje!")));
                });
            });
            ...
            inventoryHelper.setItem(19, (user.getDiscordchat() == 1) ? glass_lime : glass_red);
