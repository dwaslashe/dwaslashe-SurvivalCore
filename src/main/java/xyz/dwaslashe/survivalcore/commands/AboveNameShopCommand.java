        ...
        for (AbovenameShop serviceItem : tempItemList) {
            ItemStack service = inventoryHelper.prepareItemStack(Material.LEGACY_SKULL_ITEM, itemStack -> {
                ...
                inventoryHelper.editMetaForItemStack(itemStack, itemMeta -> {
                    ...
                    itemMeta.setLore(Api.fixColor(Arrays.asList(serviceItem.getGui_item_lore() + "", player.hasPermission(serviceItem.getPermission()) ? " &#39FF14Masz już zakupiony ten tytuł!" : " &#FBA632Koszt: &#F9731C" + serviceItem.getCost() + "$", "", player.hasPermission(serviceItem.getPermission()) ? " &#FBFD8C&nKliknij aby ustawić tytuł!" : " &#FBFD8C&nKliknij aby kupić tytuł!")));
                });
            });
